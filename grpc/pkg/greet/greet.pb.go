...
func (x *GreetEveryoneRequest) Reset() {
	*x = GreetEveryoneRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_greet_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GreetEveryoneRequest) Descriptor() ([]byte, []int) {
	return file_protos_greet_proto_rawDescGZIP(), []int{7}
}
...
func (x *GreetEveryoneResponse) Reset() {
	*x = GreetEveryoneResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_greet_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GreetEveryoneResponse) Descriptor() ([]byte, []int) {
	return file_protos_greet_proto_rawDescGZIP(), []int{8}
}
...
var file_protos_greet_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x67, 0x72, 0x65, 0x65, 0x74, 0x22, 0x4a, 0x0a, 0x08, 0x47,
	...
	0x6f, 0x6e, 0x64, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x3b, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74,
	...
	0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0xad, 0x02, 0x0a, 0x0c, 0x47, 0x72,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x0b, 0x5a, 0x09, 0x70, 0x6b, 0x67,
...
var file_protos_greet_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
...
func file_protos_greet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protos_greet_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_greet_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
